...
CREATE TABLE IF NOT EXISTS public.reagents (
    ...
    expiry_date TEXT NOT NULL, lot TEXT, cas TEXT,
    is_ordered BOOLEAN DEFAULT FALSE, last_updated TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS public.transactions (
    ...
    lot TEXT, reagent_brand TEXT, verification_status TEXT
);

-- Habilitar acceso público rápido
-- Si la BD ya existe, ejecutá solo estas líneas:
-- ALTER TABLE public.reagents ADD COLUMN IF NOT EXISTS cas TEXT;
-- ALTER TABLE public.transactions ADD COLUMN IF NOT EXISTS reagent_brand TEXT;
